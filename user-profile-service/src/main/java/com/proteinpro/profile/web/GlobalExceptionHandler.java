...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> duplicate(DataIntegrityViolationException exception,
                                                  HttpServletRequest request) {
        return response(HttpStatus.CONFLICT, "A profile already exists for this email", request);
    }
